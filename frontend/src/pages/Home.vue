    ...
    <div class="home">
        <div class="hero">
            <div class="content">
                ...
                <h2>Full-Stack Web Developer, specializing in building and optimizing web applications and eCommerce platforms.</h2>
                <div class="btn-container">
                    <router-link :to="{ name: 'contact' }" class="btn contact">Contact Me</router-link>
                </div>
            </div>
        </div>
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="wave wave-top" style="transform:rotate(0deg); transition: 0.3s" viewBox="0 0 1440 110" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0"><stop stop-color="#1e40af" offset="0%"/><stop stop-color="#1e40af" offset="100%"/></linearGradient></defs><path style="transform:translate(0, 0px); opacity:1" fill="url(#sw-gradient-0)" d="M0,11L60,18.3C120,26,240,40,360,40.3C480,40,600,26,720,29.3C840,33,960,55,1080,60.5C1200,66,1320,55,1440,51.3C1560,48,1680,51,1800,60.5C1920,70,2040,84,2160,86.2C2280,88,2400,77,2520,77C2640,77,2760,88,2880,93.5C3000,99,3120,99,3240,99C3360,99,3480,99,3600,86.2C3720,73,3840,48,3960,33C4080,18,4200,15,4320,18.3C4440,22,4560,33,4680,38.5C4800,44,4920,44,5040,51.3C5160,59,5280,73,5400,67.8C5520,62,5640,37,5760,22C5880,7,6000,4,6120,14.7C6240,26,6360,51,6480,56.8C6600,62,6720,48,6840,49.5C6960,51,7080,70,7200,78.8C7320,88,7440,88,7560,82.5C7680,77,7800,66,7920,64.2C8040,62,8160,70,8280,71.5C8400,73,8520,70,8580,67.8L8640,66L8640,110L8580,110C8520,110,8400,110,8280,110C8160,110,8040,110,7920,110C7800,110,7680,110,7560,110C7440,110,7320,110,7200,110C7080,110,6960,110,6840,110C6720,110,6600,110,6480,110C6360,110,6240,110,6120,110C6000,110,5880,110,5760,110C5640,110,5520,110,5400,110C5280,110,5160,110,5040,110C4920,110,4800,110,4680,110C4560,110,4440,110,4320,110C4200,110,4080,110,3960,110C3840,110,3720,110,3600,110C3480,110,3360,110,3240,110C3120,110,3000,110,2880,110C2760,110,2640,110,2520,110C2400,110,2280,110,2160,110C2040,110,1920,110,1800,110C1680,110,1560,110,1440,110C1320,110,1200,110,1080,110C960,110,840,110,720,110C600,110,480,110,360,110C240,110,120,110,60,110L0,110Z"/></svg>
        <div class="summary">
            <div class="content">
                <p>{{ ( new Date().getFullYear() - 2011) }}+ years of expereince building high-performance and scalable <strong>web applications</strong> and <strong>eCommerce platform</strong></p>
                <p>Web Design and Development</p>
                <p>System integrations: Product Information Managment (PIM), Payment Systems, CMS, ERP and more.</p>
                <P>Passionate about web technologies.</P>
            </div>
        </div>
        <svg xmlns:xlink="http://www.w3.org/1999/xlink" class="wave wave-bottom" style="transform:rotate(180deg); transition: 0.3s" viewBox="0 0 1440 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0"><stop stop-color="rgba(30, 64, 175, 1)" offset="0%"/><stop stop-color="rgba(30, 64, 175, 1)" offset="100%"/></linearGradient></defs><path style="transform:translate(0, 0px); opacity:1" fill="url(#sw-gradient-0)" d="M0,10L60,20C120,30,240,50,360,51.7C480,53,600,37,720,30C840,23,960,27,1080,33.3C1200,40,1320,50,1440,55C1560,60,1680,60,1800,53.3C1920,47,2040,33,2160,25C2280,17,2400,13,2520,25C2640,37,2760,63,2880,63.3C3000,63,3120,37,3240,26.7C3360,17,3480,23,3600,33.3C3720,43,3840,57,3960,58.3C4080,60,4200,50,4320,48.3C4440,47,4560,53,4680,50C4800,47,4920,33,5040,28.3C5160,23,5280,27,5400,31.7C5520,37,5640,43,5760,40C5880,37,6000,23,6120,28.3C6240,33,6360,57,6480,63.3C6600,70,6720,60,6840,61.7C6960,63,7080,77,7200,68.3C7320,60,7440,30,7560,23.3C7680,17,7800,33,7920,43.3C8040,53,8160,57,8280,56.7C8400,57,8520,53,8580,51.7L8640,50L8640,100L8580,100C8520,100,8400,100,8280,100C8160,100,8040,100,7920,100C7800,100,7680,100,7560,100C7440,100,7320,100,7200,100C7080,100,6960,100,6840,100C6720,100,6600,100,6480,100C6360,100,6240,100,6120,100C6000,100,5880,100,5760,100C5640,100,5520,100,5400,100C5280,100,5160,100,5040,100C4920,100,4800,100,4680,100C4560,100,4440,100,4320,100C4200,100,4080,100,3960,100C3840,100,3720,100,3600,100C3480,100,3360,100,3240,100C3120,100,3000,100,2880,100C2760,100,2640,100,2520,100C2400,100,2280,100,2160,100C2040,100,1920,100,1800,100C1680,100,1560,100,1440,100C1320,100,1200,100,1080,100C960,100,840,100,720,100C600,100,480,100,360,100C240,100,120,100,60,100L0,100Z"/></svg>
        <div class="experience">
            <div class="content">
                <h2 class="title">Technical Familiarity</h2>
                <div class="section">
                    <h3>Backend</h3>
...
.hero {
    ...
    .content {
        ...
        .heading {
            ...
            h1 {
                @apply mt-4 text-5xl text-center bg-gradient-to-r bg-clip-text text-transparent
        ...
        .btn-container {
            @apply flex flex-row flex-wrap justify-evenly content-around gap-4 mt-10;
            a {
                ...
                &:focus {
                    ...
                    /* Dark */
                    dark:bg-blue-100 dark:text-indigo-900;
                    transform: scale(1, 1);
                }
                &:hover::before,
                &:focus::before {
...
.wave path{
    @apply fill-current text-blue-200 dark:text-blue-800;
}
.wave-bottom {
    margin-top: -1px;
}
.summary {
    ...
    /* Dark */
    dark:from-blue-800 dark:to-blue-800;
    
    margin-top: -1px;
    .content {
        @apply flex flex-col flex-wrap justify-center items-center pt-0;
        p,
        ul li {
            @apply mb-6 text-2xl h-full mt-2 text-center leading-6;
        }        
    }
}
.experience {
    @apply flex flex-col justify-center items-center relative w-full mt-2;
    .content {
        @apply flex flex-row flex-wrap justify-around items-start pt-0;
        .section {
