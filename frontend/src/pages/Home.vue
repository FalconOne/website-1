<template>
    <div class="home">
        ...
        <div class="summary">
            <div class="content">
                <p>{{ ( new Date().getFullYear() - 2011) }}+ years building high-performance and scalable web applications and eCommerce platform</p>
                <p>Web Design and Development</p>
                <p>System integrations: Product Information Managment (PIM), Payment Systems, CSM, ERP and more.</p>
                <P>Constantly learning and expanding my technical skills.</P>
            </div>
        </div>
